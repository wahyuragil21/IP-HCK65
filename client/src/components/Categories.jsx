                ...
                <div className="relative right-0">
                    <ul className="relative flex flex-wrap p-1 list-none rounded-lg bg-black text-white" data-tabs="tabs" role="list">
                        <li className="z-30 flex-auto text-center">
                                ...
                                <a className="z-30 flex items-center justify-center w-full px-0 py-1 mb-0 transition-all ease-in-out border-0 rounded-lg cursor-pointer text-slate-700 bg-inherit hover:bg-white hover:text-black"
